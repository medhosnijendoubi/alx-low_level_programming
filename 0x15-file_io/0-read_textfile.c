...
/**
 * read_textfile - that will used to reads a text file and prints this text to posix stdout.
 ...
 *         O/w - this is the actual number of bytes of the function can read and print.
 */
